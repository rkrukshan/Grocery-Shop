...
let one =1;
  return (
    <div
      className={`fixed top-0 right-0 h-full w-full sm:w-[400px] bg-slate-200 shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${
            ...
            >
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center space-x-1">
                  <button
                    className="bg-green-500 p-2 text-white font-bold rounded-s-md"
                    onClick={() => updateQuantity(cart, item.id, 'increase')}
                  >
                    +
                  </button>
                  <div className="bg-green-500 px-3 text-white py-2 text-sm font-bold ">
                   {item.quantity}
                  </div>
                  <button
                    className="bg-green-500 p-2 text-white font-bold rounded-e-md"
          ...
          <>
            <div className="flex flex-col p-4 bg-white rounded-md">
              ...
              <div className="flex justify-between border-t pt-2 mt-2">
                <span className="flex items-center text-xl font-bold text-slate-700">
                  <NotebookIcon className="h-5 w-5 mr-2" /> Grand Total
                </span>
                <span className="text-xl font-bold text-slate-700">RS {totalPrice + 250}.00</span>
              </div>
            </div>
            ...
            <div className="bg-green-600 flex justify-between rounded-md">
              ...
              <div className="py-9 pr-4">
                <button className="flex items-center font-bold text-xl text-white hover:underline">
